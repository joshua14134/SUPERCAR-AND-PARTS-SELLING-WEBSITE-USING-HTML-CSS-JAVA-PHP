...
<body>
    <header class="header">
        <nav class="navbar container">
            <ul class="nav__list">
            <li><a href="index.php" class="logo"> <i class="ri-roadster-fill"></i> THE SUPER WHEEL</a></li>
            <li class="nav__item">
                    ...
                    <li class="nav__item">
                        <a href="parts_page.php" class="nav__link">Parts</a>
                    </li>
                    <li class="nav__item">
